defmodule ProfilePlaceWeb.UserController do
  use ProfilePlaceWeb, :controller

  import ProfilePlaceWeb.Authorize

  alias Phauxth.Log
  alias ProfilePlace.{Accounts, Accounts.User}
  alias ProfilePlaceWeb.{Auth.Token, Email}
